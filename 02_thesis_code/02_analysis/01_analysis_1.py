...
plt.savefig(r"C:\Users\Rob\Dropbox\My PC (DESKTOP-DP7OCOF)\Desktop\GIS_thesis\01_thesis_data\03_output\plots\Figure1.pdf")
plt.figure()
...
plt.xlabel("Wealth index")
plt.savefig(r"C:\Users\Rob\Dropbox\My PC (DESKTOP-DP7OCOF)\Desktop\GIS_thesis\01_thesis_data\03_output\plots\Figure2.pdf")
plt.figure()

# aridity 
sns.regplot(x='wi', y='aridity_mean_3', data=data)
plt.ylabel("Adjusted ardity index")
plt.xlabel("Wealth index")
plt.savefig(r"C:\Users\Rob\Dropbox\My PC (DESKTOP-DP7OCOF)\Desktop\GIS_thesis\01_thesis_data\03_output\plots\Figure3.pdf")
plt.figure()
