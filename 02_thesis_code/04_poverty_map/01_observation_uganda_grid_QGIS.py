...
###get data for the final extent (7 km at the moment)
...
grid7 = ee.FeatureCollection('users/RobvHaaften/uganda_grid_7');
#calculate zonal stats for grid 7

#geemap zonal stats tutorial https://tutorials.geemap.org/Analysis/zonal_statistics/
path_out = 'C:/Users/Rob/Dropbox/My PC (DESKTOP-DP7OCOF)/Desktop/GIS_thesis/01_thesis_data/02_temp/01_NTL/NTL_VIIRS_uganda_7.csv'
#calculate zonal statistics mean, scale is in meters 
geemap.zonal_statistics(NTL_mean, grid7, path_out, statistics_type='MEAN', scale=500)
...
def create_zonal_statistics():
    ...
    #input uganda grid
    input_grid = str("C:/Users/Rob/Desktop/GIS_thesis/01_thesis_data/02_temp/06_observations/03_uganda_grid/uganda_grid_7.shp")
...
out_dir = str("C:/Users/Rob/Dropbox/My PC (DESKTOP-DP7OCOF)/Desktop/GIS_thesis/01_thesis_data/02_temp/03_AR/aridity_index/aridity_index_uganda_7.csv")
pref = None 
